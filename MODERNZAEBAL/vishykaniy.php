    ...
    <div class="sidenav__wrapper col-md-5" id="sidebar">
        ...
        <div class="sidenav-footer">
            ...
            <div class="sidenav-footer__wrapper">
                ...
                <div class=" sidenav-footer__item col-md-6">
                    <a class="sidenav-footer__link" href="https://goo.gl/maps/f42kiNuhhazk1ZFPA" target="_blank">м. Городок<br>майдан Гайдамаків буд. 12
                    </a>
                </div>
            </div>
        ...
        <section class="preview container-fluid" id="preview">
                ...
                <div class="preview__block col-lg-6">
                    ...
                    <div class="preview-slider preview-slider-for">
                        <div>
                            <img class="preview-slider__image" src="./img/house/vishykaniy/house2-img4.png" alt="" srcset="">
                        </div>
                        <div>
                            <img class="preview-slider__image" src="./img/house/vishykaniy/house2-img2.png" alt="" srcset="">
                        </div>
                        <div>
                            <img class="preview-slider__image" src="./img/house/vishykaniy/house2-img3.png" alt="" srcset="">
                        </div>
                        <div>
                            <img class="preview-slider__image" src="./img/house/vishykaniy/house2-img1.png" alt="" srcset="">
                        </div>
                    </div>
                ...
                <div class="preview__block preview__block_flex col-lg-6">
                    ...
                    <div class="preview-slider preview-slider-nav">
                        <div class="preview-slider__thumb">
                            <img src="./img/house/vishykaniy/house2-img4-thumb.png" alt="" srcset="">
                        </div>
                        <div class="preview-slider__thumb">
                            <img src="./img/house/vishykaniy/house2-img2-thumb.png" alt="" srcset="">
                        </div>
                        <div class="preview-slider__thumb">
                            <img src="./img/house/vishykaniy/house2-img3-thumb.png" alt="" srcset="">
                        </div>
                        <div class="preview-slider__thumb">
                            <img src="./img/house/vishykaniy/house2-img1-thumb.png" alt="" srcset="">
                        </div>
                    </div>
